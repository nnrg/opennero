...
void CSceneNodeAnimatorCameraNeroFP::allKeysUp()
{
	for (u32 i=0; i<6; ++i)
		CursorKeys[i] = false;
}
...
void CSceneNodeAnimatorCameraNeroFP::setRotateSpeed(f32 speed)
{
	RotateSpeed = speed;
}
...
void CSceneNodeAnimatorCameraNeroFP::setMoveSpeed(f32 speed)
{
	MoveSpeed = speed;
}
...
f32 CSceneNodeAnimatorCameraNeroFP::getRotateSpeed() const
{
	return RotateSpeed;
}
...
f32 CSceneNodeAnimatorCameraNeroFP::getMoveSpeed() const
{
	return MoveSpeed;
}
...
void CSceneNodeAnimatorCameraNeroFP::setKeyMap(SKeyMap *map, u32 count)
{
	// clear the keymap
	KeyMap.clear();
...
void CSceneNodeAnimatorCameraNeroFP::setVerticalMovement(bool allow)
{
...
void CSceneNodeAnimatorCameraNeroFP::setInvertMouse(bool invert)
{
	if (invert)
...
ISceneNodeAnimator* CSceneNodeAnimatorCameraNeroFP::createClone(ISceneNode* node, ISceneManager* newManager)
{
	CSceneNodeAnimatorCameraNeroFP * newAnimator =
		new CSceneNodeAnimatorCameraNeroFP(CursorControl,	RotateSpeed, MoveSpeed, JumpSpeed,
...
void CSceneNodeAnimatorCameraNeroFP::setKeyMap(const core::array<SCamKeyMap>& keymap)
{
	KeyMap=keymap;
}
