...
class NeroPanel(wx.Panel, ScriptClient):
    def __init__(self,parent):
        ...
        #Save1 Button
        self.save1 = wx.Button(self.buttonPanel, pos=wx.DefaultPosition, size=wx.DefaultSize, label='Save Pop 1')
        buttonGrid.Add(self.save1,pos=(0,1) )
        self.Bind(wx.EVT_BUTTON, self.OnSave1, self.save1)
        
        #Load1 Button
        self.load1 = wx.Button(self.buttonPanel, pos=wx.DefaultPosition, size=wx.DefaultSize, label='Load Pop 1')
        buttonGrid.Add(self.load1, pos = (0,2) )
...
app = wx.App(False)
frame = wx.Frame(None,title = "NERO_Battle Controls",size=(600,250))
