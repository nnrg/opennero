...
#ifndef __I_SCENE_NODE_ANIMATOR_CAMERA_NERO_FP_H_INCLUDED__
#define __I_SCENE_NODE_ANIMATOR_CAMERA_NERO_FP_H_INCLUDED__
...
namespace scene
{
	...
	//! Special scene node animator for NERO-style FPS camera
	/** This scene node animator can be attached to a camera to make it act
	like a first person shooter
	*/
	class ISceneNodeAnimatorCameraNeroFP : public ISceneNodeAnimator
	{
	public:
